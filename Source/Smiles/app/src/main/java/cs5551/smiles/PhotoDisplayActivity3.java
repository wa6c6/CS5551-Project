...
public class PhotoDisplayActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //}
        setContentView(R.layout.activity_photo_display3);
...
//            }
//        });
        silovite.setImageDrawable(getResources().getDrawable(R.drawable.pic3));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(PhotoDisplayActivity3.this,PhotoDisplayActivity4.class);
                startActivity(next);
                finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent previous = new Intent(PhotoDisplayActivity3.this,PhotoDisplayActivity2.class);
...
//                StorageReference storePic = usersPhotosStorageRef.child("Photo").child(uriPath.getLastPathSegment());
                ...
                storePic.putFile(uriPath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(PhotoDisplayActivity3.this).load(getImage).resize(500,500).into(imgv);
//                        Toast.makeText(PhotoDisplayActivity.this,"Getting image..",Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(PhotoDisplayActivity3.this,"Uploaded successfully",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progess.dismiss();
                        Toast.makeText(PhotoDisplayActivity3.this,"Uploaded failed",Toast.LENGTH_SHORT).show();
                    }
                });

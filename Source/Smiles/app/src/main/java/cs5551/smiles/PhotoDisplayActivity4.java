...
public class PhotoDisplayActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //}
        setContentView(R.layout.activity_photo_display4);
...
//            }
//        });
        silovite.setImageDrawable(getResources().getDrawable(R.drawable.pic4));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(PhotoDisplayActivity4.this,PhotoDisplayActivity5.class);
                startActivity(next);
                finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent previous = new Intent(PhotoDisplayActivity4.this,PhotoDisplayActivity3.class);
                startActivity(previous);
                finish();
                 bitmap = PhotoDisplayActivity3.getArrayBmps()[0];
                //imgv.setVisibility(View.VISIBLE);
                imgv.setMaxHeight(500);
                imgv.setMaxWidth(500);
                imgv.setImageBitmap(bitmap);
...
//                StorageReference storePic = usersPhotosStorageRef.child("Photo").child(uriPath.getLastPathSegment());
                ...
                storePic.putFile(uriPath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(PhotoDisplayActivity4.this).load(getImage).resize(500,500).into(imgv);
//                        Toast.makeText(PhotoDisplayActivity.this,"Getting image..",Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(PhotoDisplayActivity4.this,"Uploaded successfully",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progess.dismiss();
                        Toast.makeText(PhotoDisplayActivity4.this,"Uploaded failed",Toast.LENGTH_SHORT).show();
                    }
                });

...
public class PhotoDisplayActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //}
        setContentView(R.layout.activity_photo_display5);
...
//            }
//        });
        silovite.setImageDrawable(getResources().getDrawable(R.drawable.pic5));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(PhotoDisplayActivity5.this,PhotoDisplayActivity6.class);
                startActivity(next);
                finish();
                 bitmap = PhotoDisplayActivity6.getArrayBmps()[0];
                //imgv.setVisibility(View.VISIBLE);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent previous = new Intent(PhotoDisplayActivity5.this,PhotoDisplayActivity4.class);
...
//                StorageReference storePic = usersPhotosStorageRef.child("Photo").child(uriPath.getLastPathSegment());
                ...
                storePic.putFile(uriPath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Picasso.with(PhotoDisplayActivity5.this).load(getImage).resize(500,500).into(imgv);
//                        Toast.makeText(PhotoDisplayActivity.this,"Getting image..",Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(PhotoDisplayActivity5.this,"Uploaded successfully",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progess.dismiss();
                        Toast.makeText(PhotoDisplayActivity5.this,"Uploaded failed",Toast.LENGTH_SHORT).show();
                    }
                });
